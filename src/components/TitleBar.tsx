...
export function TitleBar({ sessionName = "elecxterm" }: TitleBarProps) {
  ...
  return (
    <div
      className="titlebar-drag bg-bg-main flex h-9 w-full items-center justify-between border-b border-border-dim select-none transition-colors duration-300"
    ...
    >
      ...
      <div className="flex items-center gap-2.5 pl-3.5">
        ...
        <div className="flex items-center gap-1.5">
          ...
          />
          <span className="text-[11px] font-bold tracking-tight text-tx-primary opacity-90">
            {sessionName}
          </span>
        </div>
      </div>
      ...
      <div className="titlebar-no-drag flex h-full items-center">
        ...
        <button
          ...
          className="flex h-full w-11 items-center justify-center transition-colors duration-150 hover:bg-tx-primary/[0.06]"
          aria-label="最小化"
        >
          <svg width="10" height="1" viewBox="0 0 10 1" fill="currentColor" className="text-tx-secondary">
        ...
        >
          {isMaximized ? (
            <svg width="10" height="10" viewBox="0 0 10 10" fill="none" className="text-tx-secondary">
